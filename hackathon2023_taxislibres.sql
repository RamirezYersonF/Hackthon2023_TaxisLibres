...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2023 a las 23:14:16
...
--
-- Base de datos: `hackathon2023_taxislibres`
--
...
--
ALTER TABLE `departamentos`
  ADD CONSTRAINT `departamentos_ibfk_1` FOREIGN KEY (`id_departamento`) REFERENCES `municipios` (`departamento_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
